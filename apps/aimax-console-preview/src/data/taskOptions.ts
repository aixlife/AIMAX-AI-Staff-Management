 ...
 *   보여줍니다.
 *
 * 2026-09-02 CEO 최종 정정 반영:
 * - 현주는 이름·사진·영업개척 직무와 6개 입력 폼을 그대로 유지합니다.
 * - 송이는 이름·사진 그대로 보이되, 업무 맡기기 흐름은 이 폼을 열지 않고
 *   연결된 외부 서비스(HOOMCHA_URL)로 이동합니다. 아래 songiOptions 정의는
 *   실서비스 폼 참고용으로 유지하며 외부 API를 호출하지 않습니다.
 */
