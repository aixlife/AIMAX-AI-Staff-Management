...
const employees: Employee[] = [
  ...
  },
  {
    ...
    team: "콘텐츠제작팀",
    initials: "윤",
    photo: "/assets/avatar_yunmi.jpg",
    voiceLine: "같은 주제라도 타깃이 다르면 첫 문장이 달라야 합니다.",
    summary: "주제와 목적을 받아 A/B/C 타깃별 숏폼 스크립트 1안·2안·3안을 만듭니다.",
    execution: "web",
    status: "ready",
    capabilities: ["타깃별 A/B/C 3안", "숏폼 스크립트", "무료 기본 초안"],
    requiredConnections: ["AI 생성 전환 시 Gemini"],
    inputSummary: "주제, 목적, 레퍼런스",
    outputSummary: "타깃별 스크립트 1안·2안·3안",
    costSummary: "기본 초안 무료 · AI 생성은 실행 전 확인",
    lastUsed: "3일 전",
    resume: {
      employeeNo: "AIMAX-2026-YUNMI",
      team: "콘텐츠제작팀",
      experience: "6년차",
      hometown: "부산 수영",
      formerRole: "라디오 오프닝 원고 담당",
      statement: "같은 주제라도 타깃이 다르면 첫 문장이 달라야 합니다",
      intro: "주제와 목적을 받아 타깃 A/B/C에 맞춘 숏폼 스크립트 1안·2안·3안을 만드는 스크립트 작가입니다.",
      career: [
        { period: "2019-2021", org: "지역 라디오 제작팀", note: "청취자층별 오프닝 멘트를 매일 갈아 끼우며 첫 문장의 힘을 익혔습니다." },
        { period: "2021-2023", org: "숏폼 콘텐츠 스튜디오", note: "후킹, 전개, 마무리 3단 구조로 촬영 대본을 짜는 일을 맡았습니다." },
        { period: "2023-현재", org: "AIMAX 콘텐츠제작팀", note: "주제와 목적만 받으면 타깃별 스크립트 3안을 무료 초안으로 제안합니다." },
      ],
      reference: { quote: "윤미의 3안을 놓고 고르기만 하면 촬영 준비가 끝났습니다.", from: "전 채널 운영자" },
      interviewLine: "타깃이 다르면 대본도 달라야 한다고 믿습니다.",
      skills: [
        { label: "숏폼 스크립트", score: 5 },
        { label: "타깃 분화", score: 5 },
        { label: "후킹 문장", score: 4 },
        { label: "구성 3단", score: 4 },
        { label: "레퍼런스 반영", score: 4 },
      ],
    },
  },
  {
...
const tasks: Task[] = [
  ...
  },
  {
    id: "task-script-017",
    employeeId: "yunmi",
    title: "신제품 소개 숏폼 스크립트 AI 생성 전환",
    summary: "기본 초안은 무료로 만들었고, AI 생성 전환의 예상 비용 확인을 기다립니다.",
    status: "waiting_user",
    progress: 12,
    updatedAt: "7분 전",
    ...
    timeline: [
      ...
      },
      {
        id: "confirm",
        label: "사용자 확인",
        detail: "AI 생성 전환의 예상 비용과 모델을 확인해주세요.",
        state: "current",
      },
      {
        id: "analyze",
        label: "스크립트 생성",
        detail: "확인 후 A/B/C 타깃별 3안을 만듭니다.",
        state: "upcoming",
      },
      {
        id: "deliver",
        label: "결과 전달",
        detail: "타깃별 1안·2안·3안을 비교해 보여드립니다.",
        state: "upcoming",
      },
    ],
  },
...
const normalNotices: Notice[] = [
  {
    ...
    body: "윤미의 숏폼 스크립트 AI 생성 전환이 확인을 기다리고 있습니다.",
    tone: "warning",
    route: "work",
    taskId: "task-script-017",
  },
];
