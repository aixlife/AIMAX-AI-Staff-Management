...
const WORKERS = {
  ...
  max_alert: {
    ...
    releaseUrl: "",
    setupDownloadUrl: `${PUBLIC_BASE_URL}/downloads/MaxAlert-Setup-0.2.3.exe`,
    portableDownloadUrl: "",
    downloadLabel: "설치 파일 다운로드",
    supportedPlatforms: ["windows", "macos"],
    version: "0.2.3",
    ...
    executionOptions: [
      {
        ...
        platforms: ["windows"],
        status: "available",
        url: `${PUBLIC_BASE_URL}/downloads/MaxAlert-Setup-0.2.3.exe`,
        primary: true,
      ...
      },
      {
        ...
        platforms: ["macos"],
        status: "available",
        url: `${PUBLIC_BASE_URL}/downloads/MaxAlert_0.2.3_aarch64.dmg`,
        primary: false,
