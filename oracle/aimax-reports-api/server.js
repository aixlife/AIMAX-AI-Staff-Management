...
const WORKERS = {
  ...
  max_alert: {
    ...
    releaseUrl: "",
    setupDownloadUrl: "https://github.com/makefriendscoltd-design/maxalert-releases/releases/download/v0.2.3/MaxAlert-Setup-0.2.3.exe",
    portableDownloadUrl: "",
    downloadLabel: "설치 파일 다운로드",
    supportedPlatforms: ["windows", "macos"],
    version: "0.2.3",
    ...
    executionOptions: [
      {
        ...
        platforms: ["windows"],
        status: "available",
        url: "https://github.com/makefriendscoltd-design/maxalert-releases/releases/download/v0.2.3/MaxAlert-Setup-0.2.3.exe",
        primary: true,
        description: "Windows용 맥스 v0.2.3 설치 파일입니다 (Tauri 통합, 16.5MB). 레벨이 오르면 캐릭터가 알에서 전설의 갓닭까지 진화합니다.",
      },
      {
        kind: "mac_download",
        label: "Apple Silicon Mac 앱 다운로드",
        platforms: ["macos"],
        status: "available",
        url: "https://github.com/makefriendscoltd-design/maxalert-releases/releases/download/v0.2.3/MaxAlert_0.2.3_aarch64.dmg",
        primary: false,
        description: "Apple Silicon Mac용 Tauri v0.2.3 DMG입니다. 첫 실행에서 '열 수 없습니다' 안내가 뜨면 시스템 설정 > 개인정보 보호 및 보안 맨 아래의 '그래도 열기'를 눌러 실행해주세요.",
      },
    ],
  },
  eunseo: {
