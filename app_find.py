...
os.environ.setdefault("APP_MODE", "find")
os.environ.setdefault("INIT_PANEL", "find_keyword")
...
if __name__ == "__main__":
    ...
    if _run_diagnostics_probe(args):
        raise SystemExit(0)
    app = HeadlessNaverBlogAgent("find") if agent_mode_requested(args) else NaverBlogApp("find")
